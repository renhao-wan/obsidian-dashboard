...
- **Theme styles**: 14 themes defined in `src/styles/styles.css` with CSS custom properties. Theme keys: earth, nordic, aurora, island, tundra, blossom, matcha, lilac, haze, jade, carbon, onyx, mono.
